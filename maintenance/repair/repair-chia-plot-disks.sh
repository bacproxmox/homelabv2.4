...
if [[ "$count" -lt "$EXPECTED" ]]; then
  echo "⚠️ Beklenen 6 plot diskten az görünüyor. Eksik disk için Proxmox/JMicron/power/cable kontrol et."
fi
