...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/bacproxmox/homelabv2.4/main/bootstrap.sh)
```
...
```bash
cd /root
rm -rf /root/homelabv2.4
git clone https://github.com/bacproxmox/homelabv2.4.git /root/homelabv2.4
cd /root/homelabv2.4
